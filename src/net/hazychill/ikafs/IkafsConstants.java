...
public class IkafsConstants {
	...
	public static final String CONFIG_KEY_URLFETCH_DEADLINE_SECONDS = "CONFIG_KEY_URLFETCH_DEADLINE_SECONDS";
	public static final String CONFIG_KEY_MAX_USERNAME_BYTES = "CONFIG_KEY_MAX_USERNAME_BYTES";
	public static final String CONFIG_KEY_ENTRY_MAX_SUMMARY_LENGTH = "CONFIG_KEY_ENTRY_MAX_SUMMARY_LENGTH";
	public static final String CONFIG_KEY_ENTRY_INCLUDE_IMAGE = "CONFIG_KEY_ENTRY_INCLUDE_IMAGE";
	...
	public static final String[] CONFIG_KEYS = new String[] { CONFIG_KEY_FEED_ENTRY_EXPIRE_DAYS, CONFIG_KEY_MESSAGE_SPEC_EXPIRE_DAYS, CONFIG_KEY_LAST_ANALYZED_LOG_TIME,
			...
			CONFIG_KEY_REPORT_SENDER_ADDR, CONFIG_KEY_REPORT_RECEIVER_EMAILS, CONFIG_KEY_URLFETCH_DEADLINE_SECONDS, CONFIG_KEY_MAX_USERNAME_BYTES, CONFIG_KEY_ENTRY_MAX_SUMMARY_LENGTH,
			CONFIG_KEY_ENTRY_INCLUDE_IMAGE };
