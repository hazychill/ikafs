...
public class IkafsConstants {
	...
	public static final String CONFIG_KEY_URLCONNECTION_CONNECTION_TIMEOUT = "CONFIG_KEY_URLCONNECTION_CONNECTION_TIMEOUT";
	public static final String CONFIG_KEY_URLCONNECTION_READ_TIMEOUT = "CONFIG_KEY_URLCONNECTION_READ_TIMEOUT";
	...
	public static final String[] CONFIG_KEYS = new String[] { CONFIG_KEY_FEED_ENTRY_EXPIRE_DAYS, CONFIG_KEY_MESSAGE_SPEC_EXPIRE_DAYS, CONFIG_KEY_LAST_ANALYZED_LOG_TIME,
			...
			CONFIG_KEY_REPORT_SENDER_ADDR, CONFIG_KEY_REPORT_RECEIVER_EMAILS, CONFIG_KEY_URLCONNECTION_CONNECTION_TIMEOUT, CONFIG_KEY_URLCONNECTION_READ_TIMEOUT };
